...
[![Build](https://github.com/dna-dom/simple-node-mvc-starter-project/actions/workflows/run-spec-on-push.yaml/badge.svg)](https://github.com/dna-dom/simple-node-mvc-starter-project/actions/workflows/run-spec-on-push.yaml)
...
Try it out:
```terminal
$ git clone https://github.com/dna-dom/simple-node-mvc-starter-project
